...
begin
       if ASchema.ToLower = 'https://json-schema.org/draft-06/schema'      then Result := TDraftVersion.dvDraft6
  else if ASchema.ToLower = 'https://json-schema.org/draft-07/schema'      then Result := TDraftVersion.dvDraft7
  else if ASchema.ToLower = 'https://json-schema.org/draft/2019-09/schema' then Result := TDraftVersion.dvDraft2019_09
  else if ASchema.ToLower = 'https://json-schema.org/draft/2020-12/schema' then Result := TDraftVersion.dvDraft2020_12
