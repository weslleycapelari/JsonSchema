# SchemaValidator - Design Decisions

This document summarizes key architectural and technical decisions made during the development of `SchemaValidator`.
...
* **Decision**: We implemented a custom Win32 pipe wrapper using `CreateProcess` in `TestSchemaValidator.pas`.
* **Rationale**:
