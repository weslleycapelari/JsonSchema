# SchemaValidator - Product Vision

`SchemaValidator` is a lightweight, pipeline-friendly command-line wrapper built around the core Delphi `JsonSchema.Validator` library. It bridges the gap between our high-performance Delphi validation engine and automation pipelines, shell scripts, and third-party systems.
